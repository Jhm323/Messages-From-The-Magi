...
const SUIT_META = {
  Hearts: {
    ...
    element: "Water",
    color: "#C0392B",
    keywords: ["love", "relationships", "emotion", "harmony", "intuition"],
  },
  Clubs: {
    symbol: "♣",
    element: "Fire",
  ...
  Joker: {
    ...
    element: "Spirit",
    color: "#B8960C",
    keywords: ["infinite potential", "the fool's journey", "pure possibility"],
  },
};
