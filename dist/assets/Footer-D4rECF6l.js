  ...
  <div class="site-header__inner">
    ...
    <div id="site-nav-dropdown" class="nav-dropdown" aria-hidden="true">
      <nav class="nav-dropdown__nav">
        ${J.map(({href:t,label:n,icon:r,subItems:i})=>{let a=e===t||i&&i.some(t=>t.href===e);if(i){let e=i.map(e=>`
...
</header>`}function X(){let e=document.getElementById(`site-header-auth`);if(e)if(i()){let t=r(),n=t.name?.[0]?.toUpperCase()??`✦`;e.innerHTML=`
...
</footer>`}function $(e){let t=document.querySelector(e);t&&(t.insertAdjacentHTML(`afterend`,Q()),t.remove(),document.querySelectorAll(`.footer-year`).forEach(e=>{e.textContent=new Date().getFullYear()}))}export{l as a,r as c,N as i,i as l,Z as n,u as o,G as r,o as s,$ as t};