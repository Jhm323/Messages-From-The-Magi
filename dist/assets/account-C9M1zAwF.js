import{c as e,l as t,n,s as r,t as i}from"./Footer-D4rECF6l.js";import{n as a,t as o}from"./SavedReadings-1dH3-Zbr.js";function s(e=`/`){t()||window.location.replace(e)}s(`/`),n(`#site-header-mount`,{activePath:`/account.html`}),i(`#site-footer-mount`);var c=e(),l=c.name?.[0]?.toUpperCase()??`✦`,u=document.getElementById(`account-avatar`);if(c.avatar?u.innerHTML=`<img src="${c.avatar}" alt="${c.name}"
        style="width:100%;height:100%;object-fit:cover;border-radius:50%;">`:u.textContent=l,document.getElementById(`account-name`).textContent=c.name??`Seeker`,document.getElementById(`account-email`).textContent=c.email??``,c.birthday){let[e,t,n]=c.birthday.split(`-`).map(Number),r=new Date(e,t-1,n).toLocaleDateString(`en-US`,{month:`long`,day:`numeric`,year:`numeric`}),i=document.getElementById(`account-birthday`);i&&(i.textContent=r)}document.getElementById(`sign-out-btn`).addEventListener(`click`,()=>{r(),window.location.href=`/`});var d={Hearts:`var(--suit-hearts)`,Clubs:`var(--suit-clubs)`,Diamonds:`var(--suit-diamonds)`,Spades:`var(--suit-spades)`,Joker:`var(--suit-joker)`};function f(){let e=document.getElementById(`saved-readings-list`),t=a();if(t.length===0){e.innerHTML=`
